...
class GetPaginatedProductsForAdminUseCase implements IGetPaginatedProductsForAdminUseCase
{
    ...
    public function execute(int $page, int $perPage, ?string $status = null, ?int $categoryId = null): array
    {
        ...
        $result = $this->productRepository->paginate($page, $perPage, $status, $categoryId);
